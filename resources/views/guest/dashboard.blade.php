                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-md-8">
                            <ul class="d-flex nav nav-pills mb-4 text-center event-tab" id="event-pills-tab"
                                role="tablist">
                                <li class="nav-item">
                                    <a id="view-btn" class="nav-link active show" data-toggle="pill" href="#event1"
                                        data-extra="#search-with-button" role="tab" aria-selected="true">Event Type</a>
                                </li>
                                <li class="nav-item">
                                    <a id="view-schedule" class="nav-link" data-toggle="pill" href="#event2"
                                        data-extra="#view-event" role="tab" aria-selected="false">Schedule Event</a>
                                </li>
                                <li class="nav-item">
                                    <a id="view-workflow" class="nav-link" data-toggle="pill" href="#event3"
                                        data-extra="#view-data" role="tab" aria-selected="false">Workflow</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="tab-extra active" id="search-with-button">
                        <div class="iq-search-bar d-flex flex-wrap align-items-center search-device mb-4 pr-3">
                            <input class="form-control bg-white border text search-input" type="text"
                                placeholder="Search...">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="event-content">
                                            ...
                                            <div class="card-body rounded event-detail event-detail-danger disabled">
                                                <div class="d-flex align-items-top justify-content-between">
                                                    <div>
                                                        ...
                                                        <p class="mb-2 text-danger font-weight-500 text-uppercase"><i
                                                                class="las la-user pr-2"></i>One On One</p>
                                                        <p class="mb-3 card-description">Calendify always allows you to
                                                            set the reminder to optimize task management roles and jobs.
                                                        </p>
                                                        <div class="d-flex align-items-center pt-3">
                                                            <a href="#" class="btn btn-danger mr-3 px-xl-3">50 Min</a>
                                                            <a href="#"
                                                                class="btn btn-outline-danger copy d-none px-xl-3"
                                                                data-extra-toggle="copy" title="Copy to clipboard"
                                                                data-toggle="tooltip"><i
                                                                    class="las la-link pr-2"></i>Copy Link</a>
                                                            <a href="#"
                                                                class="btn btn-outline-danger turn-on px-xl-3">Turn
                                                                On</a>
                                                        </div>
                                                    </div>
                                                    <div class="card-header-toolbar mt-1">
                                                        <div class="dropdown d-none">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a class="dropdown-item" href="#"><i
                                                                        class="ri-sticky-note-line mr-3"></i>Add
                                                                    Internal Note</a>
                                                                <a class="dropdown-item" href="#"><i
                                                                        class="ri-save-line mr-3"></i>Save to
                                                                    Template</a>
                                                                <a class="dropdown-item" href="#"><i
                                                                        class="ri-code-s-slash-line mr-3"></i>Save to
                                                                    Website</a>
                                                                <a class="dropdown-item" href="#"><i
                                                ...
                                                <div class="d-flex align-items-top justify-content-between">
                                                    <div>
                                                        ...
                                                        <p class="mb-2 text-info font-weight-500 text-uppercase"><i
                                                                class="las la-user pr-2"></i>One On One</p>
                                                        <p class="mb-3 card-description">Outsmart back-and-forth in
                                                            communication by staying alert with your support team
                                                            follow-ups.</p>
                                                        <div class="d-flex align-items-center pt-3">
                                                            <a href="#" class="btn btn-info mr-3 px-xl-3">30 Min</a>
                                                            <a href="#" class="btn btn-outline-info copy px-xl-3"
                                                                data-extra-toggle="copy" title="Copy to clipboard"
                                                                data-toggle="tooltip"><i
                                                                    class="las la-link pr-2"></i>Copy Link</a>
                                                            <a href="#"
                                                                class="btn btn-outline-info d-none turn-on px-xl-3">Turn
                                                                On</a>
                                                        </div>
                                                    </div>
                                                    <div class="card-header-toolbar mt-1">
                                            ...
                                            <div class="card-body rounded event-detail event-detail-success">
                                                <div class="d-flex align-items-top justify-content-between">
                                                    <div>
                                                        ...
                                                        <p class="mb-2 text-success font-weight-500 text-uppercase"><i
                                                                class="las la-user-friends pr-2"></i>Group</p>
                                                        <p class="mb-3 card-description">Calendify lets you to simplify
                                                            and prioritize your calendar and your team’s calendar with
                                                            review. </p>
                                                        <div class="d-flex align-items-center pt-3">
                                                            <a href="#" class="btn btn-success mr-3 px-xl-3">35 Min</a>
                                                            <a href="#" class="btn btn-outline-success copy px-xl-3"
                                                                data-extra-toggle="copy" title="Copy to clipboard"
                                                                data-toggle="tooltip"><i
                                                                    class="las la-link pr-2"></i>Copy Link</a>
                                                            <a href="#"
                                                                class="btn btn-outline-success d-none turn-on px-xl-3">Turn
                                                                On</a>
                                                        </div>
                                                    </div>
                                                    <div class="card-header-toolbar mt-1">
                                            ...
                                            <div class="card-body rounded event-detail event-detail-primary">
                                                <div class="d-flex align-items-top justify-content-between">
                                                    <div>
                                                        ...
                                                        <p class="mb-2 text-primary font-weight-500 text-uppercase"><i
                                                                class="las la-user-friends pr-2"></i>Group</p>
                                                        <p class="mb-3 card-description">Quickly schedule and set the
                                                            event type to manage all your marketing and management
                                                            campaigns. </p>
                                                        <div class="d-flex align-items-center pt-3">
                                                            <a href="#" class="btn btn-primary mr-3 px-xl-3">15 Min</a>
                                                            <a href="#" class="btn btn-outline-primary copy px-xl-3"
                                                                data-extra-toggle="copy" title="Copy to clipboard"
                                                                data-toggle="tooltip"><i
                                                                    class="las la-link pr-2"></i>Copy Link</a>
                                                            <a href="#"
                                                                class="btn btn-outline-primary d-none turn-on px-xl-3">Turn
                                                                On</a>
                                                        </div>
                                                    </div>
                                                    <div class="card-header-toolbar mt-1">
                                                        <div class="dropdown">
                                                            <span class="dropdown-toggle" id="dropdownMenuButton4"
                                                                data-toggle="dropdown">
                                                                <i class="ri-more-2-fill"></i>
                                                            </span>
                                                            <div class="dropdown-menu dropdown-menu-right"
                                            ...
                                            <div class="card-body rounded event-detail event-detail-warning">
                                                <div class="d-flex align-items-top justify-content-between">
                                                    <div>
                                                        ...
                                                        <p class="mb-2 text-warning font-weight-500 text-uppercase"><i
                                                                class="las la-user-friends pr-2"></i>Group</p>
                                                        <p class="mb-3 card-description">Set reminders for your team
                                                            regarding their project and task completion so that they are
                                                            not overlooked. </p>
                                                        <div class="d-flex align-items-center pt-3">
                                                            <a href="#" class="btn btn-warning mr-3 px-xl-3">25 Min</a>
                                                            <a href="#" class="btn btn-outline-warning copy px-xl-3"
                                                                data-extra-toggle="copy" title="Copy to clipboard"
                                                                data-toggle="tooltip"><i
                                                                    class="las la-link pr-2"></i>Copy Link</a>
                                                            <a href="#"
                                                                class="btn btn-outline-warning d-none turn-on px-xl-3">Turn
                                                                On</a>
                                                        </div>
                                                    </div>
                                                    <div class="card-header-toolbar mt-1">
                                                        <div class="dropdown">
                                                            <span class="dropdown-toggle" id="dropdownMenuButton5"
                                                                data-toggle="dropdown">
                                                                <i class="ri-more-2-fill"></i>
                                                            </span>
                                                            <div class="dropdown-menu dropdown-menu-right"
                            ...
                            <div id="event2" class="tab-pane fade">
                                <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                                    <ul class="d-flex nav nav-pills text-center schedule-tab" id="schedule-pills-tab"
                                        role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="pill" href="#schedule01"
                                                data-extras="#filter-none" role="tab" aria-selected="false">All</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link active show" data-toggle="pill" href="#schedule1"
                                                data-extras="#filter-button" role="tab"
                                                aria-selected="true">Upcoming</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="pill" href="#schedule2"
                                                data-extras="#filter-none" role="tab" aria-selected="false">Pending</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="pill" href="#schedule3"
                                                data-extras="#filter-button" role="tab" aria-selected="false">Past</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="pill" href="#schedule4"
                                                data-placement="daterange" data-extras="#filter-button" role="tab"
                                                aria-selected="false">
                                                Date range
                                            </a>
                                        </li>
                                        ...
                                        <div id="filter-button"
                                            ...
                                            <div class="btn-group">
                                                <label data-toggle="dropdown" class="mb-0">
                                                    <span
                                                        class="dropdown-toggle search-query selet-caption btn bg-white">Filter
                                                        By</span><span class="search-replace"></span>
                                                    ...
                                                    <li>
                                                        <div class="item mb-2">
                                                            <div class="checkbox">
                                                                <input type="checkbox" class="checkbox-input mr-3"
                                                                    id="checkbox2">
                                                                <label for="checkbox2" class="mb-0">All Event
                                                                    Types</label>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="item mb-2">
                                                            <div class="checkbox">
                                                                <input type="checkbox" class="checkbox-input mr-3"
                                                                    id="checkbox3">
                                                                <label for="checkbox3" class="mb-0">Active
                                                                    Events</label>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <div class="item">
                                                            <div class="checkbox">
                                                                <input type="checkbox" class="checkbox-input mr-3"
                                                                    id="checkbox5">
                                                                <label for="checkbox5" class="mb-0">All Invitee
                                                                    Email</label>
                                                            </div>
                                                        </div>
                                                    </li>
                                                            ...
                                                            <div class="d-flex flex-wrap align-items-center">
                                                                ...
                                                                <div class="border-left-event pl-3">
                                                                    <div class="media align-items-top">
                                                                        ...
                                                                        <div class="badge badge-color ml-3">Upcoming
                                                                        </div>
                                                                    </div>
                                                                    <div class="media align-items-center">
                                                                        <p class="mb-0 pr-3"><i
                                                                                class="las la-clock mr-2 text-info"></i>08
                                                                            Pm - 09 Pm</p>
                                                                        <p class="mb-0"><i
                                                                                class="las la-map-marker mr-2 text-info"></i>1
                                                                            Circle Street Leominster, Ma 01453</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div
                                                                class="d-flex align-items-center list-action mt-lg-0 mt-2">
                                                                <a class="badge mr-3" data-toggle="tooltip"
                                                                    data-placement="top" title=""
                                                                    data-original-title="Edit" href="#"><i
                                                                        class="ri-edit-box-line"></i></a>
                                                                <a class="badge" data-toggle="tooltip"
                                                                    data-placement="top" title=""
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex flex-wrap align-items-center">
                                                                ...
                                                                <div class="border-left-event pl-3">
                                                                    ...
                                                                    <div class="media align-items-center">
                                                                        <p class="mb-0 pr-3"><i
                                                                                class="las la-clock mr-2 text-danger"></i>09:45
                                                                            Pm - 10 Pm</p>
                                                                        <p class="mb-0"><i
                                                                                class="las la-map-marker mr-2 text-danger"></i>1
                                                                            Circle Street Leominster, Ma 01453</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div
                                                            ...
                                                            <div class="d-flex flex-wrap align-items-center">
                                                                ...
                                                                <div class="border-left-event pl-3">
                                                                    <div class="media align-items-top">
                                                                        <h5 class="mb-3">Calendify Pre-Launch Campaign
                                                                        </h5>
                                                                        <div class="badge badge-color ml-3">Pending
                                                                        </div>
                                                                    </div>
                                                                    <div class="media align-items-center">
                                                                        <p class="mb-0 pr-3"><i
                                                                                class="las la-clock mr-2 text-success"></i>10
                                                                            Pm - 10:30 Pm</p>
                                                                        <p class="mb-0"><i
                                                                                class="las la-map-marker mr-2 text-success"></i>1
                                                                            Circle Street Leominster, Ma 01453</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="card card-block card-stretch card-height">
                                                    <div class="card-body rounded event-detail event-detail-info">
                                                        ...
                                                        <p class="mb-3 card-description">Major update v2.5 version of
                                                            Xamin theme. Make Xamin in Elementor version and document
                                                            the steps.</p>
                                                        <p class="mb-2 text-info"><i class="las la-clock mr-3"></i>08 Pm
                                                            - 09 Pm</p>
                                                        <p class="mb-0 text-info"><i
                                                                class="las la-map-marker mr-3"></i>1 Circle Street
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="card card-block card-stretch card-height">
                                                    <div class="card-body rounded event-detail event-detail-danger">
                                                        ...
                                                        <p class="mb-3 card-description">Draft an conversional and
                                                            Sales-driven Christmas campaign by offering Christmas deals
                                                            to customers. </p>
                                                        <p class="mb-2 text-danger"><i
                                                                class="las la-clock mr-3"></i>09:45 Pm - 10 Pm</p>
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="card card-block card-stretch card-height">
                                                    <div class="card-body rounded event-detail event-detail-success">
                                                        ...
                                                        <p class="mb-3 card-description">Build the best Iqonic
                                                            collectable list of WordPress themes, HTML, Vuejs Admin
                                                            Dashboards and Mobile Applications. </p>
                                                        <p class="mb-2 text-success"><i class="las la-clock mr-3"></i>10
                                                            Pm - 10:30 Pm</p>
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="card card-block card-stretch card-height">
                                                    <div class="card-body rounded event-detail event-detail1">
                                                        ...
                                                        <p class="mb-3 card-description">Enhance Calendify with
                                                            beautiful user interface and UI changes to ensure high
                                                            conversion rate.</p>
                                                        <p class="mb-2 text-info"><i class="las la-clock mr-3"></i>08 Pm
                                                            - 09 Pm</p>
                                                        <p class="mb-0 text-info"><i
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="card card-block card-stretch card-height">
                                                    <div class="card-body rounded event-detail event-detail2 active">
                                                        ...
                                                        <p class="mb-3 card-description">Schedule meetings and
                                                            promotional campaigns for your internal team by assigning
                                                            task and roles.</p>
                                                        <p class="mb-2 text-danger"><i
                                                                class="las la-clock mr-3"></i>09:45 Pm - 10 Pm</p>
                                                        <p class="mb-0 text-danger"><i
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="card card-block card-stretch card-height">
                                                    <div class="card-body rounded event-detail event-detail3">
                                                        ...
                                                        <p class="mb-3 card-description">An internal team meeting to
                                                            brief on a feature where the meeting will be seen in
                                                            viewer’s time zone with automatic timezone detection in
                                                            Calendify. </p>
                                                        <p class="mb-2 text-success"><i class="las la-clock mr-3"></i>10
                                                            Pm - 10:30 Pm</p>
                                                        <p class="mb-0 text-success"><i
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="card card-block card-stretch card-height">
                                                    <div class="card-body rounded event-detail event-detail1">
                                                        ...
                                                        <p class="mb-3 card-description">Lorem Ipsum Dolor Sit Amet,
                                                            Consecetetur Adip Iscing Elit. Pharetra Luctus Ultricies
                                                            Velit Ut. Id Tincidunt Mattis Sed Duis.</p>
                                                        <p class="mb-2 text-info"><i class="las la-clock mr-3"></i>08 Pm
                                                            - 09 Pm</p>
                                                        <p class="mb-0 text-info"><i
                                                                class="las la-map-marker mr-3"></i>1 Circle Street
                            ...
                            <div id="event3" class="tab-pane fade">
                                <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                                    <div>
                                        ...
                                        <p class="mb-md-0">Choose Your Own Workflow From Given Below.<br>Or Create Your
                                            Own Workflow</p>
                                    </div>
                                    <div class="create-workform">
                                        <a href="#create-event" data-toggle="modal" data-target="#create-event"
                                            class="btn btn-primary pr-5 position-relative">Create Workflow<span
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="card card-block card-stretch card-height">
                                            <div class="card-body rounded work-detail work-detail-info">
                                                ...
                                                <p class="mb-3 card-description">Send automated email reminder to
                                                    invitees for task.</p>
                                                <div class="pt-2">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="card card-block card-stretch card-height">
                                            <div class="card-body rounded work-detail work-detail-danger">
                                                ...
                                                <p class="mb-3 card-description">Send automated email reminder to the
                                                    meeting host.</p>
                                                <div class="pt-2">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="card card-block card-stretch card-height">
                                            <div class="card-body rounded work-detail work-detail-success">
                                                ...
                                                <p class="mb-3 card-description">Create structured step-by-step process
                                                    template for team.</p>
                                                <div class="pt-2">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="card card-block card-stretch card-height">
                                            <div class="card-body rounded work-detail work-detail-warning">
                                                ...
                                                <p class="mb-3 card-description">Quickly run multiple instances and
                                                    checklist for team.</p>
                                                <div class="pt-2">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="card card-block card-stretch card-height">
                                            <div class="card-body rounded work-detail work-detail-primary">
                                                ...
                                                <p class="mb-3 card-description">Track activity and prepare checklist to
                                                    collaborate.</p>
                                                <div class="pt-2">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="card card-block card-stretch card-height">
                                            <div class="card-body rounded work-detail work-detail-info">
                                                ...
                                                <p class="mb-3 card-description">Send text message for booking
                                                    confirmation.</p>
                                                <div class="pt-2">
                                                    <a href="#" class="btn btn-info mr-3 px-4">Use workflow</a>
                                                </div>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="card card-block card-stretch card-height">
                                            <div class="card-body rounded work-detail work-detail-danger">
                                                ...
                                                <p class="mb-3 card-description">Use forms to collect feedback of the
                                                    launch campaigns.</p>
                                                <div class="pt-2">
                                                    <a href="#" class="btn btn-danger mr-3 px-4">Use workflow</a>
                                                </div>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="card card-block card-stretch card-height">
                                            <div class="card-body rounded work-detail work-detail-success">
                                                ...
                                                <p class="mb-3 card-description">Streamline a follow-up process for the
                                                    internal team.</p>
                                                <div class="pt-2">
                                                    <a href="#" class="btn btn-success mr-3 px-4">Use workflow</a>
                                                </div>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="card card-block card-stretch card-height">
                                            <div class="card-body rounded work-detail work-detail-warning">
                                                ...
                                                <p class="mb-3 card-description">Integrate and automate daily and weekly
                                                    tasks and sales.</p>
                                                <div class="pt-2">
                                                    <a href="#" class="btn btn-warning mr-3 px-4">Use workflow</a>
                                                </div>
