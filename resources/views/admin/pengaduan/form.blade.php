        ...
        <div class="card shadow-lg border-0">
            ...
            <div class="card-body p-4">
                ...
                <form
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" id="nama_warga" class="form-control" placeholder="Pilih Pelapor..."
                                        value="{{ isset($pengaduan) ? $pengaduan->warga->nama : '' }}" readonly required>
                                    <input type="hidden" name="warga_id" id="warga_id"
                                        value="{{ isset($pengaduan) ? $pengaduan->warga_id : '' }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="kategori_id" class="form-label font-weight-bold">Kategori Pengaduan <span
                                        class="text-danger">*</span></label>
                                <select name="kategori_id" id="kategori_id" class="form-control form-select" required>
                    ...
                    <h5 class="mb-3 text-secondary">📍 Informasi Lokasi Kejadian (Opsional)</h5>
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="rt" id="rt" class="form-control" placeholder="Contoh: 005"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="rw" id="rw" class="form-control" placeholder="Contoh: 002"
                    ...
                    <div class="d-grid gap-2">
                        {{-- Tombol untuk menampilkan modal konfirmasi --}}
                        <button type="button" id="btnKonfirmasi" class="btn btn-success btn-lg" data-toggle="modal"
                            data-target="#modalKonfirmasi">
                            <i class="fas fa-paper-plane me-2"></i>
                            {{ isset($pengaduan) ? 'SIMPAN PERUBAHAN' : 'LANJUT KE KONFIRMASI' }}
                        </button>
                        {{-- Tombol submit yang sebenarnya (disembunyikan) --}}
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="table-responsive rounded">
                        <table id="datatable" class="table table-hover table-bordered data-tables">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <ul class="list-group mb-4">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            **Warga Pelapor**
                            <span id="konf_nama_warga" class="fw-bold text-primary"></span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            **Kategori**
                            <span id="konf_kategori" class="fw-bold text-primary"></span>
                        </li>
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            **Lokasi (RT/RW)**
                            <span id="konf_lokasi" class="text-muted"></span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            **Lampiran**
                            {{-- Diganti menjadi div/p untuk menampung HTML link --}}
                            <div id="konf_lampiran" class="text-muted text-end"></div>
                        </li>
                    </ul>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="btnKirimAkhir" class="btn btn-danger">
                        <i class="fas fa-check-circle me-2"></i> KIRIM LAPORAN SEKARANG
                    </button>
                </div>
...
@push('scripts')
    <script>
        // --- Fungsi untuk Modal Pilih Warga ---
        ...
        function prepareConfirmationModal() {
            ...
            const lokasiText = document.getElementById('lokasi_text').value || 'Tidak Diisi';
            const rt = document.getElementById('rt').value || 'Tidak Diisi';
            const rw = document.getElementById('rw').value || 'Tidak Diisi';
            const lampiranInput = document.getElementById('lampiran');

            let lampiranStatus = 'Tidak Ada';

            // 1. Cek jika ada file baru yang diunggah
            if (lampiranInput.files.length > 0) {
                lampiranStatus = `**File Baru:** ${lampiranInput.files[0].name}`;
            }
            // 2. Cek jika ini mode Edit dan ada lampiran lama (gunakan PHP Blade untuk ambil URL)
            ...
            // Gunakan innerHTML karena lampiranStatus kini mungkin berisi tag <a>
        ...
        document.getElementById('btnKonfirmasi').addEventListener('click', function (e) {
            ...
            // 2. Validasi form HTML5 dasar (required fields)
