            ...
            <div class="card-body p-md-5 p-3">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        @if ($pengaduan->tindak_lanjut && $pengaduan->tindak_lanjut->count())
                            {{-- Set max-height dan overflow untuk Riwayat TL agar tidak memakan terlalu banyak ruang --}}
                ...
                <div class="row mb-5">
                    <div class="col-12">
                        ...
                        @if ($pengaduan->media && $pengaduan->media->count() > 0)
                            <div class="table-responsive">
                                <table id="datatable" class="table data-tables table-striped">
                                    ...
                                    <tbody>
                                        @foreach ($pengaduan->media as $idx => $mediaItem)
                                            <tr>
                ...
                <div class="row">
                    <div class="col-12">
                        <h4 class="text-primary mb-3">
                            <i class="bi bi-plus-circle-fill me-2"></i> Tambah Tindak Lanjut Baru
                        </h4>
                        ...
                        <form action="{{ route('admin.tindaklanjut.store', $pengaduan->pengaduan_id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 mb-3">
                                    ...
                                    <textarea name="catatan" id="catatan" class="form-control" rows="3" maxlength="1000"
                                        placeholder="Tulis catatan tindak lanjut..." oninput="countChar(this)">{{ old('catatan') }}</textarea>
                            ...
                            {{-- 🔹 INPUT MULTIPLE FILE LAMPIRAN (mirip pengaduan) --}}
                            <div class="row">
                                <div class="col-12 mb-3">
                                    ...
                                    <small class="form-text text-muted">
                                        Format diizinkan: jpg, jpeg, png, pdf, docx, xlsx, pptx. Maks 10MB per file.
                                    </small>
                                    @error('lampiran.*')
                            ...
                            <div class="d-flex justify-content-end mt-3">
                                <button type="submit" class="btn btn-success btn-lg rounded-pill px-5 shadow-sm">
                                    <i class="fas fa-check-circle me-2"></i> Simpan Tindak Lanjut
                                </button>
                            </div>
                        </form>
                    </div>
