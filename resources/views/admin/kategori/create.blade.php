...
@section('konten')
    {{-- Card Utama untuk Form Tambah Kategori --}}
    {{-- MENGHAPUS justify-content-center dan pembatasan lebar LG/XL --}}
    <div class="row">
        <div class="col-sm-12"> {{-- Menggunakan lebar penuh 12 kolom --}}
            <div class="card shadow-lg border-0 rounded-4">

                {{-- CARD HEADER: Konsisten, tema Primary --}}
                <div class="card-header bg-primary text-white p-4 rounded-top-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            <i class="fas fa-plus-circle mr-3 fs-4 text-warning"></i>
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <div class="input-group input-group-lg">
                                    ...
                                    <select id="prioritas" name="prioritas"
                                        ...
                                        <option value="Sedang" {{ old('prioritas') == 'Sedang' ? 'selected' : '' }}>🟠 Sedang (Medium)</option>
