                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        @if ($p->media)
                            ...
                            @else
                                <a href="{{ $fileUrl }}" target="_blank" class="btn btn-sm btn-secondary mb-3"><i
                                        class="ri-download-line me-1"></i> Lihat Lampiran</a>
                            @endif
                        @else
                                    ...
                                    <div class="card mb-2 shadow-sm">
                                        <div class="card-body p-3">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <span class="badge bg-primary text-white">{{ $tl->aksi }}</span>
                                                <small class="text-muted">{{ $tl->created_at->format('d-m-Y H:i') }}</small>
                                            </div>
                                            <p class="mb-1"><strong>Petugas:</strong> {{ $tl->petugas ?? '-' }}</p>
                                            <p class="mb-0"><strong>Catatan:</strong> {{ $tl->catatan ?? '-' }}</p>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
